...
/// @notice This implementation of Permits links the once to the tokenId instead of the owner
...
abstract contract ERC721WithPermitUpgradeable is Initializable, IERC721WithPermit, ERC721Upgradeable {
    ...
    function __ERC721WithPermit__init() internal onlyInitializing {
        __ERC721WithPermit__init__unchained();
    }

    function __ERC721WithPermit__init__unchained() internal onlyInitializing {
        uint256 chainId;
