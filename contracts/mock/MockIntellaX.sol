 ...
 */
contract MockIntellaX is MockBaseIntellaX, IBurnable {
    string constant NAME = "Intella X";
    string constant SYMBOL = "IX";

    constructor(address admin, address initialHolder) MockBaseIntellaX(admin, NAME, SYMBOL) {
